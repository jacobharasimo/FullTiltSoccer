...
namespace DataAccess
{
    ...
    {        
        ...
        {
            var a = new MainDataDataContext();
            var result = a.GetAllCoachesCorner();
            return new List<GetAllCoachesCornerResult>(result);
        }
        [WebGet(UriTemplate = "GetAllCoachesCornerByCountry?CountryName={countryName}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        public List<GetAllCoachesCornerByCountryResult> GetAllCoachesCornerByCountry(string countryName)
        {
            var a = new MainDataDataContext();
            var result = a.GetAllCoachesCornerByCountry(countryName);
            return new List<GetAllCoachesCornerByCountryResult>(result);
        }
        [WebGet(UriTemplate = "GetAllCoachesCornerByRegionAndAge?regionName={regionyName}&age={@ageGroup}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
        public List<GetAllCoachesCornerByRegionAndAgeResult> GetAllCoachesCornerByRegionAndAge(string regionyName, string ageGroup)
        {
            var a = new MainDataDataContext();
